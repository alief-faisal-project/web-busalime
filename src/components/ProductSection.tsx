        ...
        <div className="relative max-w-4xl mx-auto">
          ...
          >
            ...
            <button
              ...
              className="absolute left-0 md:-left-6 z-30 w-10 h-10 md:w-12 md:h-12 rounded-full bg-background shadow-md flex items-center justify-center"
            >
                ...
                return (
                  <div
                    ...
                    onClick={() => {
                      ...
                      if (position === "center" && product.shopeeUrl) {
                        window.open(
                          product.shopeeUrl,
                          "_blank",
                          "noopener,noreferrer"
                    ...
                    className={`absolute transition-all duration-700 ease-out cursor-pointer
                      ...
                      ${
                        position === "left"
                          ? "-translate-x-16 md:-translate-x-28 scale-[0.65] opacity-30"
                          : ""
                      }
                      ${
                        position === "right"
                  ...
                  >
                    <img
                      src={produkImg}
                      alt={product.name}
                      className="w-32 md:w-48 lg:w-56 drop-shadow-xl"
                    />
                  </div>
                );
              })}
            ...
            <button
              onClick={goToNext}
              className="absolute right-0 md:-right-6 z-30 w-10 h-10 md:w-12 md:h-12 rounded-full bg-background shadow-md flex items-center justify-center"
            >
            ...
            {products.map((_, index) => (
              <button
                ...
                className={`h-2.5 rounded-full transition-all duration-300 ${
                  currentIndex === index
                    ? "bg-[#14532d] w-8"
                    : "bg-[#14532d]/30 w-2.5 hover:bg-[#14532d]/50"
                }`}
              />
            ))}
          </div>
